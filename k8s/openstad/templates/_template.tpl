...
{{- define "ImageS3Secret" -}}
  endpoint: {{ .Values.image.S3.endpoint | default "" | b64enc }}
  key: {{ .Values.image.S3.key | default "" | b64enc }}
  secret: {{ .Values.image.S3.secret | default "" | b64enc }}
  bucket: {{ .Values.image.S3.bucket | default "" | b64enc }}
{{- end }}
